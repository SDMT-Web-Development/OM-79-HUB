...
namespace OM_79_HUB.Models.DB.OM79Hub
{
    public class UserData
    {
        ...
        public bool RegionalEngineer { get; set; }
        public bool DirectorOfOperations { get; set; }
        public bool DeputySecretary { get; set; }       
        public string? DistrictsForRegionalEngineer { get; set; }   
    }
}
